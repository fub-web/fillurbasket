                                    ...
                                    <div className="col-md-3 col-sm-6">
                                        <div className="footer-column">
                                            ...
                                            <div className="contacts-info">
                                                <address>
                                                    <i className="add-icon"></i>FillurBasket, Telco<br />
                                                   Jamshedpur <br />
                                                </address>
                                                <div className="phone-footer"><i className="phone-icon"></i>+ 91 8210988275</div>
                                                <div className="email-footer"><i className="email-icon"></i><a
                                                    href="mailto:abc@example.com">FillurBasket@FillurBasket.com</a></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className="footer-top">
                        <div className="container">
                            <div className="row">
                                ...
                                <div className="col-sm-4 col-xs-12 coppyright"> © 2020 FillurBasket. All Rights Reserved. </div>
                                <div className="col-xs-12 col-sm-4">
