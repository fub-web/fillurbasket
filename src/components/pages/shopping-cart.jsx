                                        ...
                                        <table id="shopping-cart-table" class="data-table cart-table table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="first last odd">
                                                    <td class="image hidden-table"><Link to={'/product-details'}
                                                        title="Women&#39;s Georgette Animal Print"
                                                        class="product-image"><img src="products-images/p8.jpg" width="75"
                                                            alt="Women&#39;s Georgette Animal Print" /></Link></td>
                                                    <td>
                                                    ...
                                                    <td class="a-center last">
                                                        ...
                                                        <Link href="#" title="Remove item"
                                                            class="button remove-item"><span><span>Remove item</span></span></Link>
                                                    </td>
                                                ...
                                                <tr class="odd">
                                                    <td class="image hidden-table"><Link to={'/product-details'}
                                                        title="Women&#39;s Georgette Animal Print"
                                                        class="product-image"><img src="products-images/p3.jpg" width="75"
                                                            alt="Women&#39;s Georgette Animal Print" /></Link></td>
                                                    <td>
                                                        <h2 class="product-name">
                                                            <Link to={'/product-details'}>Fresh Organic Mustard Leaves</Link>
                                                ...
                                                <tr class="odd">
                                                    <td class="image hidden-table"><Link to={'/product-details'}
                                                        title="Women&#39;s Georgette Animal Print"
                                                        class="product-image"><img src="products-images/p1.jpg" width="75"
                                                            alt="Women&#39;s Georgette Animal Print" /></Link></td>
                                                    <td>
                                                        <h2 class="product-name">
                                                            <Link to={'/product-details'}>Fresh Organic Mustard Leaves</Link>
                                                ...
                                                <tr class="last">
                                                    <td class="image hidden-table"><Link to={'/product-details'}
                                                        title="Women&#39;s Georgette Animal Print"
                                                        class="product-image"><img src="products-images/p9.jpg" width="75"
                                                            alt="Women&#39;s Georgette Animal Print" /></Link></td>
                                                    <td>
                                                        <h2 class="product-name">
                                                            <Link to={'/product-details'}>Fresh Organic Mustard Leaves</Link>
                                                ...
                                                <form action="" method="post" id="shipping-zip-form">
                                                        ...
                                                        <li>
                                                            ...
                                                            <div class="input-box">
                                                                <select id="region_id" name="region_id" title="State/Province"
                                                                    ...
                                                                    <option value="3" title="American Samoa">American Samoa
                                                            </option>
                                                                    <option value="4" title="Arizona">Arizona</option>
                                                                    <option value="5" title="Arkansas">Arkansas</option>
                                                                    <option value="6" title="Armed Forces Africa">Armed Forces
                                                                Africa</option>
                                                                    <option value="7" title="Armed Forces Americas">Armed Forces
                                                                Americas</option>
                                                                    <option value="8" title="Armed Forces Canada">Armed Forces
                                                                Canada</option>
                                                                    <option value="9" title="Armed Forces Europe">Armed Forces
                                                                Europe</option>
                                                                ...
                                                                Columbia</option>
                                                                    ...
                                                                    <option value="30" title="Marshall Islands">Marshall Islands
                                                            </option>
                                                                    <option value="31" title="Maryland">Maryland</option>
                                                                    <option value="32" title="Massachusetts">Massachusetts
                                                            </option>
                                                                    ...
                                                                    <option value="40" title="New Hampshire">New Hampshire
                                                            </option>
                                                                    ...
                                                                    <option value="44" title="North Carolina">North Carolina
                                                            </option>
                                                                    <option value="45" title="North Dakota">North Dakota
                                                            </option>
                                                                ...
                                                                Mariana Islands</option>
                                                                    ...
                                                                    <option value="51" title="Pennsylvania">Pennsylvania
                                                            </option>
                                                                    <option value="52" title="Puerto Rico">Puerto Rico</option>
                                                                    <option value="53" title="Rhode Island">Rhode Island
                                                            </option>
                                                                    <option value="54" title="South Carolina">South Carolina
                                                            </option>
                                                                    <option value="55" title="South Dakota">South Dakota
                                                            </option>
                                                                    ...
                                                                    <option value="60" title="Virgin Islands">Virgin Islands
                                                            </option>
                                                                    <option value="61" title="Virginia">Virginia</option>
                                                                    <option value="62" title="Washington">Washington</option>
                                                                    <option value="63" title="West Virginia">West Virginia
                                                            </option>
                                                    ...
                                                    <div class="buttons-set11">
                                                        <button type="button" title="Get a Quote"
                                                            ...
                                                            class="button get-quote"><span>Get a Quote</span></button>
                                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div class="discount">
                                            ...
                                            <form id="discount-coupon-form" action="" method="post">
                                                ...
                                                <input class="input-text fullwidth" type="text" id="coupon_code"
                ...
                <div class="container">
                    <div class="row our-features-box">
                        <ul>
                            ...
                            <li class="last">
                                <div class="feature-box"> <Link href="#"><i class="fa fa-apple"></i> download</Link> <Link href="#"><i
