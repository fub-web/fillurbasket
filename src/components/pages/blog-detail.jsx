                        ...
                        <div className="row">
                            <div className="col-left sidebar col-sm-3 blog-side">
                                <div id="secondary" className="widget_wrapper13" role="complementary">
                                    <div id="recent-posts-4"
                                        ...
                                        <div className="widget-content">
                                            <ul className="posts-list unstyled clearfix">
                                                <li>
                                                    <figure className="featured-thumb"> <Link to={' '}> <img
                                                        src="images/blog-img1_1.jpg" alt="blog image" /> </Link> </figure>
                                                    {/* <!--featured-thumb--> */}
                                                    <div className="content-info">
                                                        <h4><Link to={' '} title="Lorem ipsum dolor sit amet">Powerful and flexible
                                                        premium Ecommerce themes</Link></h4>
                                                ...
                                                <li>
                                                    <figure className="featured-thumb"> <Link to={' '}> <img src="images/blog-img3.jpg"
                                                        alt="blog image" /> </Link> </figure>
                                                    {/* <!--featured-thumb--> */}
                                                    <div className="content-info">
                                                        <h4><Link to={' '} title="Lorem ipsum dolor sit amet">Awesome template with
                                                        lot's of features on the board!</Link></h4>
                                                        <p className="post-meta">
                                                ...
                                                <li>
                                                    <figure className="featured-thumb"> <Link to={' '}> <img src="images/blog-img2.jpg"
                                                        alt="blog image" /> </Link> </figure>
                                                    {/* <!--featured-thumb--> */}
                                                    <div className="content-info">
                                                        <h4><Link to={' '} title="Lorem ipsum dolor sit amet">Premium template with
                                                        unlimited colours, and fully Customizable</Link></h4>
                                                        <p className="post-meta">
                                                ...
                                                <li>
                                                    <figure className="featured-thumb"> <Link to={' '}> <img src="images/blog-img4.jpg"
                                                        alt="blog image" /> </Link> </figure>
                                                    {/* <!--featured-thumb--> */}
                                                    <div className="content-info">
                                                        <h4><Link to={' '} title="Lorem ipsum dolor sit amet">
                                                            Powerful and flexible premium Ecommerce themes</Link></h4>
                                                        <p className="post-meta">
                                    ...
                                    <div id="categories-2" className="widget widget_categories wow bounceInUp animated animated"
                                        >
                                        ...
                                        <div className="content">
                                            <ul>
                                                ...
                                                <li><Link to={' '}>Foods and Drinks</Link></li>
                                        ...
                                        <div>
                                            <div id="carousel-example-generic" className="carousel slide" data-ride="carousel">
                                                <ol className="carousel-indicators">
                                                    <li className="active" data-target="#carousel-example-generic"
                                                        data-slide-to="0"></li>
                                                ...
                                                <div className="carousel-inner">
                                                    ...
                                                    <div className="item"><img src="images/slide3.jpg" alt="slide1" />
                                                        <div className="carousel-caption">
                                                            <h4>Black Grapes</h4>
                                                            <h3><Link title=" Sample Product" to={'product-details'}>Mega
                                                            Sale</Link></h3>
                                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                                                            <Link className="link" to={' '}>Buy Now</Link>
                                                        </div>
                                                ...
                                                <Link className="left carousel-control" href="#carousel-example-generic"
                                                    data-slide="prev"> <span className="sr-only">Previous</span> </Link> 
                                                    <Link
                                                        className="right carousel-control" href="#carousel-example-generic"
                                                        data-slide="next"> <span className="sr-only">Next</span> </Link>
                                            </div>
                                        </div>
                                    </div>
                                    {/* <!-- Banner Text Block --> */}
                                    <div className="text-widget widget widget__sidebar">
                                        ...
                                        <div className="widget-content">Mauris at blandit erat. Nam vel tortor non quam scelerisque
                                    cursus. Praesent nunc vitae magna pellentesque auctor. Quisque id lectus.<br />
                                            <br />
                                        ...
                                        <div id="content" role="main">
                                            <article id="post-29" className="blog_entry clearfix">
                                                ...
                                                <div className="entry-content">
                                                    <div className="featured-thumb"><Link to={' '}><img src="images/blog-img3.jpg"
                                                        alt="blog-img4" /></Link></div>
                                                    <header className="blog_entry-header clearfix">
                                                        <div className="blog_entry-header-inner">
                                                            <h1 className="blog_entry-title">Powerful and flexible premium Ecommerce
                                                        themes</h1>
                                                        </div>
                                                    ...
                                                    <div className="entry-content">
                                                        <ul className="post-meta">
                                                            ...
                                                            <li><i className="fa fa-comments"></i><Link to={' '}>8 comments</Link> </li>
                                                            <li><i className="fa fa-clock-o"></i><span className="day">12</span> <span
                                                                className="month">Feb</span></li>
                                                        </ul>
                                                        <p>Fusce ac pharetra urna. Duis non lacus sit amet lacus interdum
                                                            facilisis sed non est. Ut mi metus, semper eu dictum nec,
                                                            condimentum sed sapien. Nullam lobortis nunc semper ipsum luctus ut
                                                            viverra ante eleifend. Nunc pretium velit sed augue luctus accumsan.
                                                </p>
                                                        <p>Aliquam laoreet consequat malesuada. Integer vitae diam sed dolor
                                                    ...
                                                    ut turpis felis. Donec sit amet quam sem, et aliquet est.</p>
                                                        <p>Quisque nisl lectus, accumsan et euismod eu, sollicitudin ac augue.
                                                            In sit amet urna magna. Curabitur imperdiet urna nec purus egestas
                                                            eget aliquet purus iaculis. Nunc porttitor blandit imperdiet. Nulla
                                                            facilisi. Cras odio ipsum, vehicula nec vehicula sed, convallis
                                                    scelerisque quam. Phasellus ut odio dui, ut fermentum neque.</p>
                                                        <blockquote>Lorem ipsum dolor sit amet, consecte adipiscing elit.
                                                            Integer aliquam mi nec dolor placerat a condimentum diam mollis. Ut
                                                    pulvinar neque eget massa dapibus dolor.</blockquote>
                                                        <p>Curabitur at vestibulum sem. Aliquam vehicula neque ac nibh suscipit
                                                            ultrices. Morbi interdum accumsan arcu nec scelerisque. Phasellus
                                                            eget purus nulla. Suspendisse quam est, tempor quis consectetur non,
                                                    ...
                                                    sed nisl in ipsum tincidunt ultrices.</p>
                                                        <h2>Heading</h2>
                                                        <p>Pellentesque volutpat mollis ligula in laoreet. Aenean est dui,
                                                            sagittis in consequat at, adipiscing at risus. Sed suscipit, est
                                                            vitae aliquam molestie, sem dolor dignissim leo, eget imperdiet enim
                                                            urna in justo. Mauris pulvinar tortor lorem. Aliquam sed nisl in
                                                    ipsum tincidunt ultrices.</p>
                                                        <ul>
                                                    ...
                                                    ipsum tincidunt ultrices.</p>
                                                        <h4>Heading</h4>
                                                        <p>Nullam commodo lobortis nibh, vitae accumsan velit dapibus sed. Nunc
                                                            ...
                                                            amet molestie est. Donec id turpis vitae leo viverra adipiscing at
                                                            sed nisi. Donec ut justo nunc. Vivamu bibendum erat ac nunc
                                                    sollicitudin lacinia. Phasellus sed lacus magna.</p>
                                                        <h5>Heading</h5>
                                                        <p>Nullam commodo lobortis nibh, vitae accumsan velit dapibus sed. Nunc
                                                            ac sem eu libero pretium faucib. Quisque et semper odio. Praesent
                                                            tortor ligula, imperdiet sed aliquet ut, pharetra at nisi. Etiam sit
                                                        ...
                                                        <li className="comment">
                                                            <div>
                                                                ...
                                                                <div className="comment-text">
                                                                    ...
                                                                    <p className="meta">
                                                                        <strong>Stephen Smith</strong> <span>–</span> <time>June
                                                                    02, 2018</time>
                                                                    </p>
                                                                    <div className="description">
                                                ...
                                                <div className="comments-form-wrapper clearfix">
                                                    ...
                                                    <form className="comment-form" method="post" id="postComment" action="">
                                                        <div className="field">
                                                            ...
                                                            <input type="text" className="input-text" title="Name" value=""
                                                                id="user" name="user_name" />
                                                        </div>
                                                        <div className="field">
                                                            <label for="email">Email<em className="required">*</em></label>
                                                            <input type="text" className="input-text validate-email" title="Email"
                                                        ...
                                                        <div className="field aw-blog-comment-area">
                                                            ...
                                                            <textarea rows="5" cols="50" className="input-text" title="Comment"
                                                                id="comment" name="comment"></textarea>
                                                        </div>
                                                        <div className="button-set">
                                                            <input type="hidden" value="1" name="blog_id" />
                                                            <button type="submit" className="bnt-comment"><span><span>Add
